...
\def\cvdversion{0.3.0}

\hypersetup{
    pdftitle={The dichromacy package (v\cvdversion)},
...
\title{The dichromacy package (v\cvdversion)}
...
\begin{figure}[ht]
	...
	\begin{minipage}{0.5\textwidth}
		\centering
		\includegraphics[width=0.8\textwidth]{../../docs/images/test_image-dichromacy-protanopia-1.0.png}\\
		protanopia, severity 1
	\end{minipage}\\[0.5em]
	\begin{minipage}{0.5\textwidth}
		\centering
		\includegraphics[width=0.8\textwidth]{../../docs/images/test_image-dichromacy-deuteranopia-0.5.png}\\
		deuteranopia, severity 0.5
	\end{minipage}\hfill
	\begin{minipage}{0.5\textwidth}
		\centering
		\includegraphics[width=0.8\textwidth]{../../docs/images/test_image-dichromacy-tritanopia-0.8.png}\\
